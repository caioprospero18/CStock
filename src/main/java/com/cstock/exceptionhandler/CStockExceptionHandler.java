package com.cstock.exceptionhandler;
...
@ControllerAdvice
public class CStockExceptionHandler extends ResponseEntityExceptionHandler{
	...
	public ResponseEntity<Object> handleNonExistentUserException(NonExistentUserException ex) {
		String userMessage = messageSource.getMessage("user.non-existent", null, LocaleContextHolder.getLocale());
		String developerMessage = ExceptionUtils.getRootCauseMessage(ex);
		List<Error> errors = Arrays.asList(new Error(userMessage, developerMessage));
